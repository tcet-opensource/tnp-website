    ...
    return ( 
        <div className="flex flex-col sm:flex-row sm:justify-around border-t-2 border-gray-100 p-6 bg-gradient-to-t from-purple-200 ...">
            <div className="flex flex-col items-center sm:items-start">
                <div><img className="h-24 object-contain" src={"../../logos/tcet_os.png"} alt="tcet_os" /></div>
            ...
            <div className="hidden sm:block"><img className="h-30 object-contain" src={"../../misc/astronaut.png"} alt="astronaut" /></div>
        </div>
    );
  }
