  ...
  return (
    <div>
      ...
      {IndustryInteractionData.map((data) => (
        ...
        >
          <div className={`flex flex-col h-full mb-4 align-middle p-5 ${data.imageLeftAlign ? "xl:ml-6 md:ml-6":"xl:ml-0 md:ml-0"} sm:ml-0 xl:w-1/2 md:1/2 sm:w-full`}>
            <img
            ...
            <p className="xl:w-4/5 md:w-4/5 sm:w-full">
              {data.description}
            </p>
          </div>
